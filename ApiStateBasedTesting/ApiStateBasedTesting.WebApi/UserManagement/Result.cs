...
namespace ApiStateBasedTesting.WebApi.UserManagement
{
    public static class Result
    {
        ...
        public static IResult<S2, E> Select<S1, S2, E>(this IResult<S1, E> source, Func<S1, S2> selector)
        {
        ...
        public static IResult<S, E> Join<S, E>(this IResult<IResult<S, E>, E> source)
        {
        ...
        public static IResult<S2, E> SelectMany<S1, S2, E>(this IResult<S1, E> source, Func<S1, IResult<S2, E>> selector)
        {
            return source.Select(selector).Join();
        }

        public static IResult<S2, E> SelectMany<S1, S2, U, E>(this IResult<S1, E> source, Func<S1, IResult<U, E>> k, Func<S1, U, S2> s)
        {
            return source
                .SelectMany(x => k(x)
        ...
        public static IResult<S2, E2> SelectBoth<S1, S2, E1, E2>(this IResult<S1, E1> source, Func<S1, S2> successSelector, Func<E1, E2> errorSelector)
        {
